...
enum class FitnessManagerErrors(val code: String, val message: String) {
    ...
    UNKNOWN_EVENT("UnknownEvent", "Тренировка с таким идентификатором не найдена"),
    UNKNOWN_CLIENT_CARD("UnknownClientCard", "Карточка клиента с таким идентификатором не найдена"),
    ERROR_CREATE_SPORT_ACTIVITY("ErrorCreateSportActivity", "У вас уже есть тренировка с данным клиентом в этом время"),
